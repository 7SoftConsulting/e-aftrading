...
Financier UEMOA" ;
				...
				$this->MenuListeTransacts = $this->BarreMenuSuperfish->MenuRacine->InscritSousMenuScript("listeAchatsDevise") ;
				$this->MenuListeTransacts->Titre = "Op&eacute;rations bancaires" ;
				$this->MenuOpChangeDevise = $this->MenuListeTransacts->InscritSousMenuScript("listeAchatsDevise") ;
