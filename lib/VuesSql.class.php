...
on t1.num_op_change = t2.num_op_change") ;
		define("TXT_SQL_POSTUL_OP_CHANGE_TRAD_PLATF", "select t1.*, case when t1.commiss_ou_taux = 0 then t1.mtt_commiss when t1.type_taux = 0 then t1.taux_change else t1.ecran_taux end taux_transact, t2.login loginop, t2.nomop, t2.prenomop, t4.id_entite, t4.code code_entite, t4.shortname nom_court_entite, t4.name nom_entite
from op_change t1
...
on t1.num_op_inter = t2.num_op_inter") ;
		define("TXT_SQL_POSTUL_OP_INTER_TRAD_PLATF", "select t1.*, case when t1.commiss_ou_taux = 0 then t1.mtt_commiss when t1.type_taux = 0 then t1.taux_change else t1.ecran_taux end taux_transact, t2.login loginop, t2.nomop, t2.prenomop, t4.id_entite, t4.code code_entite, t4.shortname nom_court_entite, t4.name nom_entite
from op_inter t1
left join operateur t2
on t1.numop = t2.numop
