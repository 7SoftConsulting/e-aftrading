<?php
	...
	if(! defined('FOURN_EXPRS_TRAD_PLATF'))
	{
		...
		class FournExprsPublTradPlatf extends PvObjet
		{
			...
			public $TitrFenConsultEmissBonTresor = 'Consultation &eacute;mission obligation' ;
			public $TitrFenProposEmissBonTresor = 'Propositions &eacute;mission obligation' ;
			public $TitrFenDetailProposEmissBonTresor = 'D&eacute;tails  proposition &eacute;mission obligation' ;
			public $TitrFenAjoutEmissBonTresor = 'Ajout &eacute;mission obligation' ;
			public $TitrFenModifEmissBonTresor = 'Modification &eacute;mission obligation' ;
			public $TitrFenSupprEmissBonTresor = 'Suppression &eacute;mission obligation' ;
